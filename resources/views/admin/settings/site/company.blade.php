											...
											<ul>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="{{url('company-settings')}}" class="active">Company
																Settings </a></li>
														...
														<li><a href="{{url('social-authentication')}}">Social
																Authentication</a></li>
												...
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="{{url('invoice-templates')}}">Invoice Templates</a>
														</li>
												...
												<li class="submenu">
													...
													<ul>
														<li class="submenu submenu-two"><a
															...
															<ul>
																<li><a href="{{url('email-settings')}}">Email Settings</a>
																</li>
																<li><a href="{{url('email-templates')}}">Email Templates</a>
																</li>
															</ul>
														</li>
														<li class="submenu submenu-two"><a
															...
															<ul>
																...
																<li><a href="{{url('sms-templates')}}">SMS Templates</a>
																</li>
															</ul>
														</li>
												...
												<li class="submenu">
													...
													<ul>
														<li><a href="{{url('payment-gateway-settings')}}">Payment
																Gateway</a></li>
