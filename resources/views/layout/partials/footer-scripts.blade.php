 ...
 @if (Route::is(['admin-dashboard','barcode','calendar','chart-apex','companies','email-reply','dashboard','email','file-manager','form-elements','icon-feather','icon-flag','icon-fontawesome','icon-ionic','icon-material','icon-pe7','icon-remix','icon-simpleline', 'icon-tabler','icon-themify', 'icon-typicon','icon-weather','index','admin.dashboard','layout-boxed','layout-dark','layout-detached','layout-horizontal','layout-hovered','layout-rtl','layout-two-column','notes','pos','pos-2','pos-3','pos-4','pos-5','qrcode','sales-dashboard','todo-list','todo']))
    <!-- Chart JS -->
...
@if (Route::is(['admin.products.create','all-blog','blog-tag','domain','edit-product','email-reply','localization-settings','otp-settings','packages','product-list','purchase-transaction','reviews','subscription','varriant-attributes']))
...
@endif
 ...
 @if (Route::is(['chart-js','subscription','dashboard','index','admin.dashboard','layout-horizontal','layout-detached','layout-two-column','layout-dark','layout-boxed','layout-rtl','subscription']))
     <!-- Chart JS -->
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (imageInput && imagePreview && removeBtn) {
        ...
        // Clicking the preview box opens file input
